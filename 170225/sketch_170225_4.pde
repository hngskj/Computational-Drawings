...
CustomShape[] shapes = new CustomShape[12];
...
void setup(){
  ...
  for (int i=0; i<shapes.length; i++){
    shapes[i] = new CustomShape(floor(random(250, 320)),
...
class CustomShape{
  ...
  CustomShape(int n, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float x5, float y5, float x6, float y6){
    c = n;
    ...
    vel1.mult(random(0.1,0.5));
    vel2.mult(random(0.1,0.5));
    vel3.mult(random(0.1,0.5));
    vel4.mult(random(0.1,0.5));
    vel5.mult(random(0.1,0.5));
    vel6.mult(random(0.1,0.5));
  }
